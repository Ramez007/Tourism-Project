	...
	<div id="fh5co-hotel-section">
		<div class="container">
			<div class="row">
                <div class="col-md-12">
                        <div class="topnav">
                        <!-- <a href="#home">Reservaions</a>
                        <a href="#news">Hotels</a>
                        <a href="#contact">Packages</a>
                        <a href="#about">About Us Content</a> -->
                        <span onclick="showsec('res-sec')"><a href="#reservations">Reservations</a></span>
                        <span onclick="showsec('hotels-sec')"><a href="#hotels">Hotels</a></span>
                        <span onclick="showsec('packages-sec')"><a href="#packages">Packages</a></span>
                        <span onclick="showsec('about-sec')"><a href="#about">About us content</a></span>
                        <span onclick="showsec('main-page-sec')"><a href="#main">Main Page content</a></span>
                        <span onclick="showsec('contact-page-sec')"><a href="#contact">Contact Page content</a></span>
                        </div>
                </div>
...
Check-out after breakfast and transfer to Cairo International Airport for final departure.
                   ...
                   <!-- Editing About us Section -->
                    ...
                    <!-- End Editing Main Page Section -->  

                    <!-- Editing Contact Page Section -->
                    <div id="contact-page-sec">
...
<!-- ------------------------------------------------------------------------------------------------------------ -->
    <script type="text/javascript">
		function showsec(y) {
			idarr = ["res-sec", "hotels-sec", "packages-sec", "about-sec", "main-page-sec", "contact-page-sec"]
